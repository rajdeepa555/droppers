...
from ebayapi.connection import BaseConnection
from ebayapi.config import Config
from ebayapi.utils import getNodeText, dict2xml, smart_encode
from ebayapi.exception import RequestPaginationError, PaginationLimit
...
class Connection(BaseConnection):
    ...
    def __init__(self, **kwargs):
        ...
        parallel      -- ebayapi parallel object
        ...
        print("inside trading init file")
